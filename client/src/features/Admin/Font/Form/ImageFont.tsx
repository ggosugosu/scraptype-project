    ...
    (): ImageFontItem[] => [
      {
        ...
        name: 'unit',
        description: '( Unit / 90 x 90 / 1MB / SVG)',
        value: formData?.unit,
      },
      {
        type: UploadType.TITLE,
        name: 'title',
        description: '( Title / Hug x 108 / 1MB / JPEG)',
        value: formData?.title,
      },
      {
        type: UploadType.DETAIL_DESKTOP,
        name: 'detailPc',
        description: '( Detail View Contents / PC / 1MB / JPEG )',
        value: formData?.detailPc,
      },
      {
        type: UploadType.DETAIL_MOBILE,
        name: 'detailMob',
        description: '( Detail View Contents / MO / 1MB / JPEG )',
